      ...
      <div class="container">
        ...
        <div class="row mb-5 align-items-end">
          <div class="col-md-6" data-aos="fade-up">
            <h2>Kontak</h2>
            <p class="mb-0"> Hubungi saya untuk informasi lebih lanjut.
            </p>
          </div>
          ...
          <div class="col-md-4 ml-auto order-2" data-aos="fade-up">
            <ul class="list-unstyled">
              <li class="mb-3">
                ...
                <span> Kp. Cikarang No.39, Desa Gunung Guruh, Kabupaten Sukabumi</span>
              </li>
              <li class="mb-3">
                <strong class="d-block mb-1">Telepon</strong>
                <span>+62 857 2064 4655</span>
              </li>
              <li class="mb-3">
                <strong class="d-block mb-1">Email</strong>
                <span>Dinda.bdg2017@gmail.com</span>
              </li>
            </ul>
          </div>
